...
cp "/h/dev_hb/AlarmCenterTestTools/Release/直连型主机模拟器V1.20.exe" dist/examples/x86/
cp "/h/dev_hb/AlarmCenterTestTools/Release/AdemcoParser.exe" dist/examples/x86/
