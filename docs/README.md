...
|事件码类型|主机类型|防区|有线防区|电话报警|内核负责人|在售主机型号与图标|
|---------|-------|----|-------|-------|---------|----------------|
|1707--我是网络模块|3 网络模块+工程主机|1~999|1~8||jjf|<ul><li>HB-G250 <img alt="HB-G250" src="./主机类型/smartresize/HB-G250-web.png" style="max-height:80px" /></li></ul>|
|1717--我是GPRS主机|4 GPRS主机|1~99||Yes|wzq|<ul></ul>|
|1727--我是液晶主机|5 液晶主机|1~249||Yes|jjf|<ul><li>HB-BJQ560 <img alt="HB-BJQ560" src="./主机类型/smartresize/HB-BJQ560-web.png" style="max-height:80px" /></li><li>HB-BJQ560B <img alt="HB-BJQ560B" src="./主机类型/smartresize/HB-BJQ560B-web.png" style="max-height:80px" /></li></ul>|
