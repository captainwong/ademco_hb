...
#define HMT_EVENT_MAP(XX)                       \
    ...
    XX(HMT_BELL, EVENT_I_AM_BELL)               \
    XX(HMT_TRAIN, EVENT_I_AM_TRAIN)
...
HB_EXPORT_SYMBOL ademco_event_t hb_machine_status_to_ademco_event(hb_machine_status_t status);

HB_EXPORT_SYMBOL hb_machine_status_t hb_machine_status_from_ademco_event(ademco_event_t ademco_event);

HB_EXPORT_SYMBOL ademco_event_t hb_machine_type_to_ademco_event(hb_machine_type_t type);

HB_EXPORT_SYMBOL hb_machine_type_t hb_machine_type_from_ademco_event(ademco_event_t ademco_event);

HB_EXPORT_SYMBOL ademco_event_t hb_zone_property_to_ademco_event(hb_zone_property_t zp);

HB_EXPORT_SYMBOL ademco_event_t hb_rf_code_to_ademco_event(uint8_t rf_code);
